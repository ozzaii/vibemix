...
export const HERCULES_INPULSE_500_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 720" role="img" aria-label="Hercules DJControl Inpulse 500 schematic" class="learn-controller-schematic">
  <!-- Faceplate outline -->

...
export const GENERIC_CONTROLLER_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 720" role="img" aria-label="Generic DJ controller schematic" class="learn-controller-schematic">

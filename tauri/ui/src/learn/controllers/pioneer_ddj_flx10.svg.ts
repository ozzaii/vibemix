...
//
// Phase 91 Plan 06 — DDJ-FLX10 inline-SVG controller schematic.
//
// Provenance: Hand-authored from the DDJ-FLX10 "Operating Instructions"
...
// vendor logo, NO faceplate photo-lift, NO brand-orange). The FLX10 is
// the 4-channel rekordbox-pro flagship; per the vibemix profile
// (decks: A/B/C/D), we render all four channel strips and four jog
// wheels in compressed-column form so the 1280×720 viewBox accommodates
// the wider mixer without losing the CDJ-Whisper visual budget. The
// master FX section adds the filter_fx engage button (no tap_tempo on
// this controller).
//
...
// binding in src/vibemix/midi/profiles/pioneer_ddj_flx10.json, and
// every profile binding resolves to a group here. The 42-entry set is:
...
export const PIONEER_DDJ_FLX10_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 720" role="img" aria-label="Pioneer DDJ-FLX10 schematic" class="learn-controller-schematic">
  ...
  <!-- Master FX strip: filter_fx engage -->
  <g data-control-id="filter_fx" role="button" aria-label="master filter FX" tabindex="0"
     data-cx="640" data-cy="395">
    <rect x="608" y="378" width="64" height="34" rx="4" ry="4"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <text x="640" y="400" font-family="'JetBrains Mono', monospace" font-size="8"

...
//
// Phase 91 Plan 06 — Numark Party Mix Live inline-SVG schematic.
//
// Provenance: Hand-authored from the Numark Party Mix Live "Quickstart
// Guide" hardware-layout (publisher: inMusic Brands, ©2021 revision;
// Apache-clean derivative geometry — factual control layout only, NO
// vendor logo, NO faceplate photo-lift). The Party Mix Live is the
// entry-level Numark 2-deck with integrated speakers + Serato Lite
// default mapping; the jog "wheels" are slim circular touch-pads (not
// the platter-style discs of Pioneer flagships) but the profile binds
// no jog_touch button, so the jog area is decorative only.
//
// CDJ-Whisper aesthetic: silk-22 strokes on warm-black void,
// currentColor throughout. Same anti-slop posture as the rest.
//
// Parity contract (RENDER-06): every data-control-id resolves to a
// binding in src/vibemix/midi/profiles/numark_party_mix_live.json, and
// every profile binding resolves to a group here. The 21-entry set is:
...
export const NUMARK_PARTY_MIX_LIVE_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 720" class="learn-controller-schematic">
  ...
  <!-- ============================================================= -->
  <!-- DECK A — slim jog pad + transport + 4-pad hotcue grid         -->
  <!-- ============================================================= -->

  <!-- Jog A (decorative — Party Mix uses slim touch pads, profile binds
       no jog_touch) -->
  <circle cx="265" cy="240" r="80" stroke="currentColor" stroke-width="1.5" fill="none" opacity="0.7"/>
  <circle cx="265" cy="240" r="58" stroke="currentColor" stroke-width="1" fill="none" opacity="0.4"/>
  <line x1="265" y1="170" x2="265" y2="195" stroke="currentColor" stroke-width="1.5"/>
  <text x="265" y="338" font-family="'JetBrains Mono', monospace" font-size="8"
        letter-spacing="0.16em" text-anchor="middle" fill="currentColor" opacity="0.45">JOG PAD</text>
  ...
  <!-- Hot-cue pad grid A — 4 pads in a row (Party Mix signature
       large square performance pads) -->
  <g data-control-id="hotcue:A" role="button" aria-label="hot-cue pads, deck A" tabindex="0">
    <rect x="155" y="450" width="58" height="42" rx="5" ry="5"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="223" y="450" width="58" height="42" rx="5" ry="5"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="291" y="450" width="58" height="42" rx="5" ry="5"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="359" y="450" width="58" height="42" rx="5" ry="5"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <text x="285" y="515" font-family="'JetBrains Mono', monospace" font-size="8"
  ...
  <!-- ============================================================= -->
  <!-- MIXER — EQ stacks + filter + faders + crossfader              -->
  <!-- ============================================================= -->
  ...
  <!-- Jog B (decorative slim pad) -->
  <circle cx="1015" cy="240" r="80" stroke="currentColor" stroke-width="1.5" fill="none" opacity="0.7"/>
  <circle cx="1015" cy="240" r="58" stroke="currentColor" stroke-width="1" fill="none" opacity="0.4"/>
  <line x1="1015" y1="170" x2="1015" y2="195" stroke="currentColor" stroke-width="1.5"/>
  <text x="1015" y="338" font-family="'JetBrains Mono', monospace" font-size="8"
        letter-spacing="0.16em" text-anchor="middle" fill="currentColor" opacity="0.45">JOG PAD</text>
  ...
  <g data-control-id="hotcue:B" role="button" aria-label="hot-cue pads, deck B" tabindex="0">
    <rect x="905" y="450" width="58" height="42" rx="5" ry="5"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="973" y="450" width="58" height="42" rx="5" ry="5"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="1041" y="450" width="58" height="42" rx="5" ry="5"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="1109" y="450" width="58" height="42" rx="5" ry="5"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <text x="1035" y="515" font-family="'JetBrains Mono', monospace" font-size="8"
          letter-spacing="0.16em" text-anchor="middle" fill="currentColor" opacity="0.55">HOT CUE 1-4</text>
    <g class="cue-color"></g>
    <g class="cue-shape"></g>
  </g>

...
//
// Phase 91 Plan 06 — DDJ-SX3 inline-SVG controller schematic.
//
// Provenance: Hand-authored from the DDJ-SX3 "Operating Instructions"
...
// vendor logo, NO faceplate photo-lift, NO brand-orange). The DDJ-SX3 is
// the Serato-flagship 4-deck (Serato-default mapping); profile declares
// 4 deck channels with hot-cue pad surfaces on decks A/B only (the C/D
// layer is shift-accessed, out of vibemix v1 scope per profile binding
// which only includes hotcue_1..hotcue_4 per deck).
//
// CDJ-Whisper aesthetic: silk-22 strokes on warm-black void,
// currentColor throughout. Wire-key cardinality identical to the
// DDJ-1000 (Serato + rekordbox conventions converged on the same 4-deck
// CC/note layout; visual differs because the SX3 surfaces the Serato
// signature 8-pad strip — we render 4 pads in a horizontal row to
// align with the profile-bound hotcue_1..hotcue_4 set).
//
// Parity contract (RENDER-06): every data-control-id resolves to a
// binding in src/vibemix/midi/profiles/pioneer_ddj_sx3.json, and
...
export const PIONEER_DDJ_SX3_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 720" class="learn-controller-schematic">
  ...
  <!-- Hot-cue pad grid A — Serato signature horizontal 4-pad strip
       (the profile binds hotcue 1..4 on deck A, all reducing to the
       single wire-key hotcue:A per profile.field/kind reduction;
       hotcues 5..8 are shift-layered and not bound in v1) -->
  <g data-control-id="hotcue:A" role="button" aria-label="hot-cue pads, deck A" tabindex="0">
    <rect x="98" y="395" width="40" height="40" rx="4" ry="4"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="146" y="395" width="40" height="40" rx="4" ry="4"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="194" y="395" width="40" height="40" rx="4" ry="4"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="242" y="395" width="40" height="40" rx="4" ry="4"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <text x="190" y="460" font-family="'JetBrains Mono', monospace" font-size="8"
  ...
  <g data-control-id="hotcue:B" role="button" aria-label="hot-cue pads, deck B" tabindex="0">
    <rect x="318" y="395" width="40" height="40" rx="4" ry="4"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="366" y="395" width="40" height="40" rx="4" ry="4"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="414" y="395" width="40" height="40" rx="4" ry="4"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <rect x="462" y="395" width="40" height="40" rx="4" ry="4"
          stroke="currentColor" stroke-width="1.5" fill="none"/>
    <text x="410" y="460" font-family="'JetBrains Mono', monospace" font-size="8"
          letter-spacing="0.16em" text-anchor="middle" fill="currentColor" opacity="0.55">HOT CUE 1-4</text>
    <g class="cue-color"></g>
    <g class="cue-shape"></g>
  </g>

...
export const PIONEER_DDJ_1000_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 720" role="img" aria-label="Pioneer DDJ-1000 schematic" class="learn-controller-schematic">
  <!-- Faceplate outline -->

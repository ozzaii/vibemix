...
export const MOCK_TRANSFER_CONTRACT: readonly MockTransferSurface[] = [
  ...
  },
  {
    ...
    requiredWires: [
      ...
      { wire: "library.mode-tabs", purpose: "Viber mode anchor" },
      ...
      { wire: "library.cue-field", purpose: "hot-cue export controls folded into Build" },
      ...
      { wire: "library.chat-folder", purpose: "native folder picker from Viber chat" },

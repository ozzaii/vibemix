...
7. **Yellow-defer stubs** at `.planning/archive/2026-05-27-stale-v2-v3-research/v3-buckets/v3.x-<slug>.md` per Yellow row — 8 expected (Mixxx OSC / controller transpiler / pyrekordbox depth / Beat This! / Voicemeeter Banana / controller library expansion / macOS 26+ / Win11 24H2 WASAPI).
...
All v3.x candidates (Mixxx OSC, Beat This!, controller library expansion, etc.) carry forward to `.planning/archive/2026-05-27-stale-v2-v3-research/v3-buckets/` as Yellow-defer stubs per OPP-05. None escalated to v3.1 scope.

...
**Success Criteria** (what must be TRUE):
  ...
  3. v3.1 final scan outcome documents zero (or near-zero per CONTEXT `feedback_no_scope_creep_clean_utility`) new runtime deps; Yellow-defer candidates carried forward into `.planning/archive/2026-05-27-stale-v2-v3-research/v3-buckets/` for v3.x re-evaluation (OPP-05).

# Requirements Archive: v3.1 Distribution-Ready Pass
...
- [ ] **OPP-05** — Final scan outcome documents zero (or near-zero) new runtime deps as the v3.1 expected steady state; deferred candidates (Yellow) carry forward into `.planning/archive/2026-05-27-stale-v2-v3-research/v3-buckets/` for v3.x re-evaluation.

...
- **Pre-synth bark PCM cache** (ship gate before launch, not slice gate): fixed bark bank warm-synthesized on round load, keyed by tts_marker, <500ms lock barks. The thunk-first layering carries the slice demo.

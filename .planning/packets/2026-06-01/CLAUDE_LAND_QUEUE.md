...
- **Date:** 2026-06-01 (re-pinned 2026-06-02) · **Pinned HEAD:** `36225bae` (`docs(planning): mark drop cooldown landed`; re-pin before judging if Codex lands again) · **Maintained by:** Claude read-only swarm.

...
- **Date:** 2026-06-01 (re-pinned 2026-06-02) · **Pinned HEAD:** `3e9af0d9` (`fix(state): throttle drop-call events`; re-pin before judging if Codex lands again) · **Maintained by:** Claude read-only swarm.

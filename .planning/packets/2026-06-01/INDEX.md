...
| [`CODEX_READY-rekordbox-deck-hint-honesty.md`](CODEX_READY-rekordbox-deck-hint-honesty.md) | Split safety packet for stale Rekordbox deck-output hints | **LAND packet, deck-audio honesty slice.** Current Rekordbox output rows gate auto deck-pair hints, and unverified auto pairs stay honest-null for the Judge; full controller-weighted master remains HOLD. |

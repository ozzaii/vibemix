...
**What goes wrong:** The funded key hits a rate limit mid-run and the whole phase fails (this exact 429 already blocked the floor-data study — see `gemini-audio-truth-test.md`).
...
- `.planning/research/one-mind-charter.md` — the multi-dimensional bench spec + two-study scope + no-audio cell
- `.planning/research/gemini-audio-truth-test.md` — the floor study (3-model genre disagreement; the 429 billing block lesson → fail-safe requirement)

...
**Out:** NO new AI/embedding provider (Gemini-only), NO new ws port/IPC envelope, NO making Gemini the primary perceiver, NO new DSP. Additive — with the audio-secondary path gated OFF, the prompt + reaction are byte-identical to the v8.0 baseline.
</domain>

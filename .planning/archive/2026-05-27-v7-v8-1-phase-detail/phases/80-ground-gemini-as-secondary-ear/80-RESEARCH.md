...
### Secondary (MEDIUM)
- `.planning/archive/2026-05-27-stale-one-mind-research/one-mind-charter.md`, `.planning/archive/2026-05-27-stale-one-mind-research/gemini-audio-truth-test.md`, `.planning/REQUIREMENTS.md` — milestone intent + raw-ear floor data.

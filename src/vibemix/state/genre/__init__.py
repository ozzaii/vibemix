...
Phase 6 Wave 1 surface: GenreProfile dataclass + JSON loader + active-profile
singleton.

Phase 6 Wave 2 surface (this commit): crest_factor + EmaSmoother + validate_bpm
+ VocalDetector.

Later waves extend with: classify_phase_percentile, HysteresisState.
"""

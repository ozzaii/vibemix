...
_CHAT_RULES_BLOCK = (
    ...
    "and do not treat that BPM/key range as verified.\n"
    "3. To inspect several candidates, call inspect_candidates ONCE with all "
    "track_ids instead of looping get_track_features / get_track_sections / "
    "get_track_energy per track.\n"
    "4. For mix-point or cue-entry advice, use get_track_sections, "
    ...
    "5. Ground a web or technique claim with the matching tool "
    "(web_search / retrieve_dj_knowledge) — let the source "
    "show.\n"
    "6. You do NOT have to call a tool every turn; if they're just chatting, "
    "chat back.\n"
    "7. When done, return the final JSON {reply, tools_used, tool_trace, "
    ...
    "8. If a live/deck/move answer has weak evidence, do not confess, apologize, "

...
def test_debrief_near_miss_roundtrip_with_replay_window():
    ...
    assert parsed["payload"]["ear_test_clip_relative_path"] == "near_miss_ear_test.wav"
    assert parsed["payload"]["friend_line_audio_relative_path"] == "debrief_friend_line.mp3"
...
def test_debrief_near_miss_roundtrip_quiet_state():
    ...
    assert parsed["payload"]["ear_test_clip_relative_path"] is None
    assert parsed["payload"]["friend_line_audio_relative_path"] is None

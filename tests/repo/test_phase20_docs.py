...
def test_active_planning_docs_pin_viber_to_codex_not_gemini_fallback():
    ...
    # STACK.md was regenerated by the 2026-06-08 codebase-map refresh
    # (704a4ccc) — the old "Library/Viber uses local Codex" sentence became
    # the MCP-server line pinning the same contract: the grounded library
    # tools are exposed to the Codex Viber CLI, never to the live co-host.
    assert "Codex Viber CLI" in _read(".planning/codebase/STACK.md")
